...
function getPDO()
{
    $opt = array(
     ...
     //$pdo = new PDO("mysql:host=localhost;dbname=apukhtina", "root", "", $opt); // у меня на localhost так работает
    //для university.netology
//    define('DB_HOST', 'localhost');
//    define('DB_USER', 'apukhtina');
//    define('DB_PASS', 'neto0796');
//    define('DB_NAME', 'apukhtina');
//
//    $pdo = new PDO('mysql:host=' . DB_HOST . ';dbname=' . DB_NAME . ';charset=UTF8', DB_USER, DB_PASS);
//4.2
    $pdo = new PDO("mysql:host=localhost;dbname=apukhtina;charset=UTF8", "apukhtina", "neto0796");
    return $pdo;
